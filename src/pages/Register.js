                  ...
                  <div className="max-w-sm md:w-2/3" >
                      ...
                      <form >
                        <div className="flex items-center border-b border-gray-400 py-2 mb-2">
                            ...
                            <input
                            className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="School Name" aria-label="Full Name" />
                        </div>
